                        ...
                        <div class="divide-y divide-gray-200">
                            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                <div class="flex flex-col">
                                    <label class="leading-loose">Title <span class="text-red-400 text-sm">(*)</span></label>
                                ...
                                <div class="flex flex-col">
                                    <label class="leading-loose">Price <span class="text-red-400 text-sm">(*)</span></label>
                                ...
                                <div class="flex flex-col">
                                    <label class="leading-loose">Category <span class="text-red-400 text-sm">(*)</span></label>
                                    <select
                                ...
                                <div class="flex flex-col">
                                    <label class="leading-loose">Location <span class="text-red-400 text-sm">(*)</span></label>
                                    <select
                                        class="px-4 py-1 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                        id="select-location"
                                        name="locations[]"
                                ...
                                <div class="flex flex-col">
                                    <label class="leading-loose">Description <span class="text-red-400 text-sm">(*)</span></label>
